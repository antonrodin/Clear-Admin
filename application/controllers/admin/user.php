...
class User extends CI_Controller {
    ...
    public function add_user_form() {
        ...
        $this->data['error'] = 'Fields marked with an asterisc are required';
    ...
    public function edit_user_form($id) {
            ...
            $this->data['error'] = 'Fields marked with an asterisc are required';
            $this->data['id'] = $id;
            $this->data['submenu']['Edit user'] = 'admin/user/edit_user_form/' . $id . '.html';
    ...
    public function reset_password_form($id = -1) {
        if ($id != -1) {
            ...
            $this->data['id'] = $id;
            $this->data['submenu']['Reset password'] = 'admin/user/reset_password_form/' . $id . '.html';
            $this->data['suboption'] = 'sb-3';
    ...
    private function init_config() {
        ...
        $submenu = array(
            'User list' => 'admin/user/list_user.html',
            'Add user' => 'admin/user/add_user_form.html'
        );
